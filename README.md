...
## 🛡️ Quản Lý An Toàn & Bảo Mật

Để đảm bảo an toàn thông tin khách hàng, bảo vệ tài sản xe, và quản lý rủi ro khi khách thuê mang xe đi xa, vui lòng tham khảo tài liệu chi tiết:

📄 **[QUAN_LY_AN_TOAN.md](QUAN_LY_AN_TOAN.md)**

Tài liệu này bao gồm:

- Xác minh danh tính và kiểm tra bằng lái
- Hệ thống GPS theo dõi vị trí thời gian thực
- Quản lý hợp đồng và điều kiện thuê
- Kiểm tra tình trạng xe trước/sau khi giao
- Quản lý nhiên liệu và giới hạn quãng đường
- Quản lý hành vi lái xe an toàn
- Quản lý bảo hiểm và bồi thường
...
Hiện tại, dự án được cấu hình cho môi trường **development**. Trước khi deploy lên production, vui lòng tham khảo tài liệu chi tiết:

📄 **[SECURITY.md](SECURITY.md)** - Hướng dẫn bảo mật toàn diện
...
**Các bước cơ bản:**
1. **Đổi SECRET_KEY** - Sử dụng `django-insecure-*`
2. **Thiết lập DEBUG = False**
3. **Cấu hình ALLOWED_HOSTS**
4. **Sử dụng PostgreSQL** thay SQLite
5. **Cấu hình HTTPS/TLS**
6. **Thiết lập .env file** cho environment variables
7. **Bật các tính năng bảo mật** trong settings.py
